...
async function* getDiagnostics(directory, cancellationToken, logging = false) {
    ...
    let files;
    const jsConfig = Path__default['default'].resolve(directory, 'jsconfig.json');
    const tsConfig = Path__default['default'].resolve(directory, 'tsconfig.json');
    if (FS__default['default'].existsSync(tsConfig) || FS__default['default'].existsSync(jsConfig)) {
        useProject = true;
        const configFile = FS__default['default'].existsSync(tsConfig) ? tsConfig : jsConfig;
...
exports.cli = cli$1;
exports.getDiagnostics = getDiagnostics$1;
