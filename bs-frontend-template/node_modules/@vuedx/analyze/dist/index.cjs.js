...
function createComponentInfoFactory(fileName) {
    const component = {
        name: shared.getComponentName(fileName),
        aliases: shared.getComponentNameAliases(fileName),
        fileName,
        description: '',
        tags: [],
        props: [],
    ...
    const factory = {
        ...
        addLocalComponent(name, source, loc = null, kind = 'script') {
            const aliases = shared.isPascalCase(name) ? [name, shared.kebabCase(name)] : [name];
    ...
    babel: (path$, ctx) => {
        ...
        if (path$.isExportNamedDeclaration()) {
            ...
            if (((_a = node.source) === null || _a === void 0 ? void 0 : _a.value.endsWith('.vue')) === true) {
                ...
                if (specifier != null) {
                    const name = getComponentName(specifier.exported);
...
function toVeturData(components) {
    ...
    components.forEach((component) => {
        const name = shared.kebabCase(component.name);
        data.tags[name] = {
            description: component.description,
            attributes: [],
        };
        component.props.forEach((prop) => {
            const propName = shared.kebabCase(prop.name);
...
function getComponentFromFile(fileName) {
    if (fileName.endsWith('.vue') || fileName.endsWith('.tsx')) {
        const name = shared.getComponentName(fileName);
        return [
            {
                name,
                aliases: shared.getComponentNameAliases(fileName),
    ...
    if (pkg['web-types'] != null) {
        try {
            ...
            (_c = (_b = (_a = info.contributions) === null || _a === void 0 ? void 0 : _a.html) === null || _b === void 0 ? void 0 : _b.tags) === null || _c === void 0 ? void 0 : _c.forEach((tag) => {
                var _a, _b;
                const componentName = shared.getComponentName(tag.name);
                components.push({
                    name: componentName,
                    aliases: shared.getComponentNameAliases(tag.name),
                    source: {
        ...
        try {
            ...
            Object.keys(info).forEach((tag) => {
                const componentName = shared.getComponentName(tag);
                components.push({
                    name: componentName,
                    aliases: shared.getComponentNameAliases(tag),
                    source: {
                        moduleName: packageName,
                        localName: componentName,
        ...
        this.config.globalComponents.forEach((option) => {
            ...
            if (typeof option === 'string') {
                ...
                Object.entries(option).forEach(([name, config]) => {
                    const componentName = shared.getComponentName(name);
                    ...
                    this._globalComponents.push({
                        name: componentName,
                        aliases: shared.getComponentNameAliases(name),
                        source: {
