      ...
      <template #dropdown>
        <el-dropdown-menu>
          ...
          <el-dropdown-item divided>
            <el-link target="_blank" :underline="false" href="http://127.0.0.1:8000/admin">前往后台</el-link>
          </el-dropdown-item>
          <el-dropdown-item divided @click="logout" v-if="loginRequired">退出登录</el-dropdown-item>
        </el-dropdown-menu>
      </template>
    </el-dropdown>
